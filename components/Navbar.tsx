    ...
    return (
        <div className="flex justify-between items-center py-1 font-medium px-2 mb-10 max-sm:px-0">
            ...
            <div className="flex justify-start max-xl:justify-center items-center gap-5 max-xl:gap-2">
                <Image
                    className="max-xl:hidden max-lg:w-32 mx-2"
                ...
                <nav>
                    ...
                    <div className="max-xl:block hidden max-sm:w-8 px-5" onClick={() => setMenuHandler((curr) => !curr)}>
            ...
            <label onClick={() => setBasket(false)} className={`${basket ? 'block' : 'hidden'} bg-black opacity-50 w-full h-full right-0 top-0 absolute z-10`}></label>
            <div className="flex gap-3 max-lg:gap-1 justify-center items-center max-xl:flex-row-reverse">
                <div className="relative">
                    ...
                    <div className={`${basket ? 'scale-100 opacity-100' : 'opacity-0 scale-90'} duration-300 dark:bg-black max-xl:left-10 max-sm:left-0 absolute -left-20 z-20 bg-white rounded-md transform transition-all w-96 max-sm:w-[350px] h-52 border-2`}>
