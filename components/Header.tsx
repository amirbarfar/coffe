...
export default function Header() {
    ...
    return (
        <div className="flex justify-between items-center py-5 font-medium max-sm:px-5 px-5">
            <div className="flex justify-start items-center gap-5 max-xl:gap-0 max-md:gap-2">
                ...
                />
                <nav>
                    <div className={`${menuHandler ? 'max-md:opacity-100 max-md:scale-100' : 'max-md:scale-80 max-md:opacity-0'} right-0 transition-all z-20 transform duration-500 ease-in-out flex justify-center items-center gap-8 max-md:absolute max-md:block top-0 max-md:border-2 text-lg max-md:bg-white max-md:leading-7 max-md:w-72 max-sm:text-sm max-md:text-sm max-md:min-h-screen max-md:rounded-md`}>
                        <div className={`max-lg:${menuHandler ? 'opacity-100 scale-100' : "opacity-0 scale-90"} flex  h-24 justify-start absolute max-lg:flex items-center opacity-0 top-0 w-full max-lg:bg-[#f4f4f4]`}>
                            <Image
                        ...
                        <ul className="my-2 max-md:border-b-2 max-md:px-5 max-md:pb-6 md:pt-2 md:px-2 max-lg:text-sm text-base flex justify-center items-center max-md:items-start gap-5 max-md:flex-col max-md:mt-28">
                            <li>
                                <Link href="">خانه</Link>
                            </li>
                            <li>
                        ...
                        <div className="">
                            <div onClick={() => setToggleMode((curr) => !curr)} className="w-full h-12 max-sm:w-10 hidden max-md:flex max-sm:h-10 cursor-pointer justify-start px-2 items-center gap-2 rounded-full">
                                {
                                    toggleMode ? (
                                        <div className="flex justify-center gap-1 items-center ">
                                            ...
                                            <p className="max-sm:w-44">لایت مود</p>
                                        </div>
                                    ) : (
                                        <div className="flex justify-center gap-1 items-center">
                                            ...
                                            <p className="max-sm:w-44">دارک مود</p>
                                        </div>
                                    )
                                }
                            </div>
            ...
            <div className="flex gap-3 max-lg:gap-0">
                <div onClick={() => setBasket((curr) => !curr)} className="w-12 h-12 mr-20 max-md:mr-0 max-sm:w-8 max-sm:h-10 max-lg:mr-0 cursor-pointer flex justify-center items-center rounded-full">
                    <svg className="max-sm:w-6 max-sm:h-6" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="cursor-pointer max-sm:text-sm max-md:hidden max-xl:text-sm">ورود | عضویت</button>
                <div onClick={() => setToggleMode((curr) => !curr)} className="w-8 h-12 cursor-pointer max-md:hidden flex justify-center items-center rounded-full">
                    {
                        toggleMode ? (
                            <svg className="w-6 h-6 max-sm:h-5 max-sm:w-5" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M19.9358 14.3652C20.0691 14.0415 19.9906 13.6679 19.7389 13.4276C19.4872 13.1873 19.115 13.1308 18.8051 13.2857C17.7584 13.8091 16.5801 14.1034 15.3317 14.1034C10.9835 14.1034 7.45846 10.5246 7.45846 6.1098C7.45846 4.32254 8.0352 2.67449 9.01033 1.34372C9.21644 1.06244 9.22917 0.680892 9.04229 0.386091C8.85541 0.0912907 8.50809 -0.054977 8.17055 0.0189828C3.50017 1.04235 2.17361e-07 5.25905 0 10.3077C-2.50276e-07 16.1208 4.64155 20.8333 10.3672 20.8333C14.6778 20.8333 18.372 18.1625 19.9358 14.3652Z" fill="currentColor"></path>
                                <path fillRule="evenodd" clipRule="evenodd" d="M13.0928 3.67116L13.7596 1.84183C13.9751 1.25035 14.4797 0.939795 14.9987 0.910156C15.5177 0.939795 16.0222 1.25035 16.2378 1.84183L16.9045 3.67116L18.7063 4.34807C19.9329 4.8089 19.9329 6.57032 18.7063 7.03114L16.9045 7.70806L16.2378 9.53738C16.0222 10.1289 15.5177 10.4394 14.9987 10.4691C14.4797 10.4394 13.9751 10.1289 13.7596 9.53738L13.0928 7.70806L11.2911 7.03114C10.0644 6.57032 10.0644 4.8089 11.2911 4.34807L13.0928 3.67116Z" fill="currentColor" fill-opacity="0.4"></path>
                            </svg>
                        ) : (
                            <svg className="w-6 h-6 max-sm:h-5 max-sm:w-5" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M11.8025 18.0871C7.03723 18.0871 5.4658 16.5156 5.51682 11.8013C5.56785 7.08705 7.03723 5.51562 11.8025 5.51562C16.5678 5.51562 18.0882 7.08705 18.0882 11.8013C18.0882 16.5156 16.5678 18.0871 11.8025 18.0871Z" fill="currentColor"></path>
                                <path d="M11.8008 0.800781C12.2347 0.800781 12.5865 1.15256 12.5865 1.5865V3.15792C12.5865 3.59186 12.2347 3.94364 11.8008 3.94364C11.3668 3.94364 11.0151 3.59186 11.0151 3.15792V1.5865C11.0151 1.15256 11.3668 0.800781 11.8008 0.800781Z" fill="currentColor" fill-opacity="0.4"></path>
                                <path d="M12.5865 20.4436C12.5865 20.0097 12.2347 19.6579 11.8008 19.6579C11.3668 19.6579 11.0151 20.0097 11.0151 20.4436V22.0151C11.0151 22.449 11.3668 22.8008 11.8008 22.8008C12.2347 22.8008 12.5865 22.449 12.5865 22.0151V20.4436Z" fill="currentColor" fill-opacity="0.4"></path>
                                <path d="M22.8008 11.8008C22.8008 12.2347 22.449 12.5865 22.0151 12.5865H20.4436C20.0097 12.5865 19.6579 12.2347 19.6579 11.8008C19.6579 11.3668 20.0097 11.0151 20.4436 11.0151H22.0151C22.449 11.0151 22.8008 11.3668 22.8008 11.8008Z" fill="currentColor" fill-opacity="0.4"></path>
