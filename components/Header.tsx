...
export default function Header() {
    ...
    return (
        <div className="flex justify-between items-center py-5 font-medium max-sm:px-5 px-2">
            <div className="flex justify-start items-center gap-5 max-xl:gap-0 max-md:gap-2">
                ...
                />
                <nav>
                    <div className={`${menuHandler ? 'max-md:opacity-100 max-md:scale-100 max-lg:right-0' : 'max-md:scale-80 max-md:opacity-0 max-lg:-right-72'} right-0 transition-all z-20 transform duration-500 ease-in-out flex justify-center items-center gap-8 max-md:absolute max-md:block top-0 max-md:border-2 text-lg max-md:bg-white max-md:leading-7 max-md:w-72 max-sm:text-sm max-md:text-sm max-md:min-h-screen max-md:rounded-md`}>
                        <div className={`max-lg:${menuHandler ? 'opacity-100 scale-100' : "opacity-0 scale-90"} flex h-24 justify-start absolute md:opacity-0 items-center top-0 w-full max-lg:bg-[#f4f4f4]`}>
                            <Image
                        ...
                        <ul className="my-2 text-xl max-lg:text-base max-md:border-b-2 max-md:px-5 max-md:pb-6 md:pt-2 md:px-2 flex justify-center items-center max-md:items-start gap-5 max-md:flex-col max-md:mt-28">
                            <li>
                                <Link href="">خانه</Link>
                            </li>
                            <li>
                        ...
                        <div className="w-auto mx-3 md:hidden h-12 my-5 px-2 flex justify-center items-center border-2 rounded-lg max-sm:text-sm">
                            <input type="text" className="w-full h-full rounded-lg px-3 bg-white outline-0" placeholder="دنبال چی میگردی ؟" />
                        ...
                        <div className="duration-300 cursor-pointer hover:bg-blue-600 transition-all bg-blue-500 h-full w-full rounded-lg">
                            <div onClick={() => setToggleMode((curr) => !curr)} className="w-full h-12 text-white hidden max-md:flex max-sm:h-10 cursor-pointer justify-center px-2 items-center gap-2 rounded-full">
                                {
                                    toggleMode ? (
                                        ...
                                        <div className="flex justify-center gap-1 items-center rounded-lg">
                                            <svg className="w-6 h-6" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path color="white" d="M11.8008 0.800781C12.2347 0.800781 12.5865 1.15256 12.5865 1.5865V3.15792C12.5865 3.59186 12.2347 3.94364 11.8008 3.94364C11.3668 3.94364 11.0151 3.59186 11.0151 3.15792V1.5865C11.0151 1.15256 11.3668 0.800781 11.8008 0.800781Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M12.5865 20.4436C12.5865 20.0097 12.2347 19.6579 11.8008 19.6579C11.3668 19.6579 11.0151 20.0097 11.0151 20.4436V22.0151C11.0151 22.449 11.3668 22.8008 11.8008 22.8008C12.2347 22.8008 12.5865 22.449 12.5865 22.0151V20.4436Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M22.8008 11.8008C22.8008 12.2347 22.449 12.5865 22.0151 12.5865H20.4436C20.0097 12.5865 19.6579 12.2347 19.6579 11.8008C19.6579 11.3668 20.0097 11.0151 20.4436 11.0151H22.0151C22.449 11.0151 22.8008 11.3668 22.8008 11.8008Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M3.15792 12.5865C3.59186 12.5865 3.94364 12.2347 3.94364 11.8008C3.94364 11.3668 3.59186 11.0151 3.15792 11.0151H1.5865C1.15256 11.0151 0.800781 11.3668 0.800781 11.8008C0.800781 12.2347 1.15256 12.5865 1.5865 12.5865H3.15792Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M3.38805 3.38805C3.6949 3.08121 4.19238 3.08121 4.49922 3.38805L5.61039 4.49922C5.91723 4.80606 5.91723 5.30355 5.61039 5.61039C5.30355 5.91723 4.80606 5.91723 4.49922 5.61039L3.38805 4.49922C3.08121 4.19238 3.08121 3.6949 3.38805 3.38805Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M4.49922 20.5388C4.19238 20.8457 3.6949 20.8457 3.38805 20.5388C3.08121 20.232 3.08121 19.7345 3.38805 19.4277L4.49922 18.3165C4.80606 18.0097 5.30355 18.0097 5.61039 18.3165C5.91723 18.6233 5.91723 19.1208 5.61039 19.4277L4.49922 20.5388Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M20.5388 3.38805C20.232 3.08121 19.7345 3.08121 19.4277 3.38805L18.3165 4.49922C18.0097 4.80606 18.0097 5.30355 18.3165 5.61039C18.6233 5.91723 19.1208 5.91723 19.4277 5.61039L20.5388 4.49922C20.8457 4.19238 20.8457 3.6949 20.5388 3.38805Z" fill="currentColor" fill-opacity="0.4"></path>
                                                <path color="white" d="M19.4277 20.5388C19.7345 20.8457 20.232 20.8457 20.5388 20.5388C20.8457 20.232 20.8457 19.7345 20.5388 19.4277L19.4277 18.3165C19.1208 18.0097 18.6233 18.0097 18.3165 18.3165C18.0097 18.6233 18.0097 19.1208 18.3165 19.4277L19.4277 20.5388Z" fill="currentColor" fill-opacity="0.4"></path>
                                            </svg>
                                            <p>دارک مود</p>
                                        </div>
                                    )
            ...
            <div className="flex gap-3 max-lg:gap-1">
                ...
                <div onClick={() => setToggleMode((curr) => !curr)} className="w-8 h-12 cursor-pointer max-md:hidden flex justify-center items-center rounded-full">
                    {
                        toggleMode ? (
                            <svg className="w-7 h-7 max-sm:h-5 max-lg:w-5" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`${basket ? 'scale-100 opacity-100' : 'opacity-0 scale-90'} duration-300 absolute z-20 bg-white left-10 top-24 rounded-md transform transition-all w-96 h-52 border-2`}>
